% Fluvoxamine Population of Models — FEMALE ventricular model.
...
title('AP — Fluvoxamine max dose, Female POM');
xlabel('Time (ms)');
...
title('Calcium Transient — Fluvoxamine max dose, Female POM');
xlabel('Time (ms)');
ylabel('Ca_i (mM)');
