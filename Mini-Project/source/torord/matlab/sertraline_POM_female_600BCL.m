...
title('Action Potential — Female population of models for a maximum therapeutic dose of Sertraline');
xlabel('Time (ms)');
...
writetable(T, fullfile(outdir, 'sertraline_female_BCL_600.csv'));
fprintf('Saved POM_results/sertraline_female_BCL_600.csv\n');
