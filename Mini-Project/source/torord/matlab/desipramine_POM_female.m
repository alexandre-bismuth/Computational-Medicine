...
title('Action Potential — Female population of models for a maximum therapeutic dose of Desipramine');
xlabel('Time (ms)');
...
writetable(T, fullfile(outdir, 'desipramine_female.csv'));
fprintf('Saved POM_results/desipramine_female.csv\n');
